...
export const ERROR : Record<string, FailedResponse> = {
    ...
    "ServiceUnavailableException": { status: 5000, message: "현재 해당 요청을 처리할 수 없습니다.\n나중에 다시 시도해주세요."},
    "ServerDatabaseError": { status: 5001, message: "데이터 베이스 작업 중, 오류가 발생했습니다.\n로그를 확인해주세요." },
    "UnKnownException": { status: 5002, message: "알 수 없는 오류가 발생했습니다.\n 로그를 확인해주세요." }
}
